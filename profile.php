        ...
        <div class="center-content" >
            ...
            <div class="row" style="margin-left:480;">
                ...
                <?php
                    ...
                    echo'    
                        <div class="card mb-3" style="max-width: 540px;margin-top:30">
                            <div class="row g-0" style="margin:20">
                                <div class="col-md-4">
                                    <img src="../images/user-'.$row['id'].'.png" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title" style="margin-left:45">'.$row['name'].'</h5>
                                        <div style="margin-top:30">
                                            <p class="card-text">E-mail : '.$row['email'].'</p>
                                            <p class="card-text">Account Number : '.$row['account number'].'</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div style="margin-left:30">
                                ...
                                <p>Date of Birth : '.$row['date of birth'].'</p>
                                <p>Phone Number : '.$row['phone number'].'</p>
                                <p>Address : '.$row['address'].'</p>
                            </div>
                            <div style="margin-bottom:30">
                                <span style="margin-left:180;margin-bottom:30"><a href="Transfer money.php?user_id='.$row['id'].'" class="btn " >Transfer Money</a></span>
                            </div>
                        <div>';
                ?>       
            </div>
